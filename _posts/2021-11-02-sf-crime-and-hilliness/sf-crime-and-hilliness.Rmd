...
crimes <- crimes %>% 
  ...
  select(slope_over_20, median_income, elev, geometry)
```
...
ggplot(data = crimes_summary, aes(x = median_income, y = count)) +
  geom_point()

ggplot(data = crimes_summary, aes(x = elev, y = count)) +
  geom_point()

ggplot(data = crimes_summary, aes(x = slope_over_20, y = count)) +
  geom_point()
```
