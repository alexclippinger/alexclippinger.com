...
```{r load data}
#census_blocks <- st_read("data/census_blocks/census_blocks.shp", query = "SELECT * FROM census_blocks WHERE aland10 > 0")
...
crimes <- st_read("data/crime_reports_2018_present/crime_reports_2018_present.shp", query = "SELECT * FROM crime_reports_2018_present WHERE incident_2 = 'Motor Vehicle Theft'") 
```
