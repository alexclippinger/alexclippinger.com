...
- **Control variable**: Median income
...
- Crime and elevation data for this analysis were retrieved from the [San Francisco Open Data Portal](https://datasf.org/opendata/).
  ...
  - [Crime](https://data.sfgov.org/Public-Safety/Police-Department-Incident-Reports-2018-to-Present/wg3w-h783) 
    ...
    - Locations aggregated to street intersections.

  - [Elevation contours](https://data.sfgov.org/Energy-and-Environment/Elevation-Contours/rnbg-2qxw) 
    - 5 ft. elevation contours
    - Also used to derive **slope**. This was achieved through a geo-processing workflow in QGIS (see [this video](https://www.youtube.com/watch?v=MvnW6w1_yJg) for a walk through of this process).

- Median income
  - Retrieved through the `tidycensus` package via the US Census Bureau.
  - census Tract detail from the 5-year 2019 ACS data.
