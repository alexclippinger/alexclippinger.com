...
The box plots more clearly demonstrate that both elevation and slope have more occurrences at low values than high values, with extremely high outliers. These outliers are mostly trustworthy - the highest peak in San Francisco is Mount Davidson at 938 feet and the steepest surveyed road is Bradford Street at 41% grade. This indicates that two of the slope outliers are likely due to data artifacts.
...
1. **Fixing the OLS assumption violation**, either by transforming the data or using another estimator.
2. Adding more key socio-economic and demographic variables.
